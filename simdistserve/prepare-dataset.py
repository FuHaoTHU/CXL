    ...
    if name.lower() == "sharegpt":
        ...
        for file in tqdm.tqdm(files):
            with open(file, "r") as f:
                for line in f.readlines():
                    ...
                    context_len_allowed = min(8184 - answer_len, random.randint(args.longbench_min_prompt_len, args.longbench_max_prompt_len))
        ...
        with open(dataset_path, "r") as f:
            for line in f.readlines():
                ...
                if len(context_token_ids) + len(answer_token_ids) >= 8192:
                    continue
...
if __name__ == "__main__":
    ...
    parser.add_argument("--longbench-max-prompt-len", type=int, default=8192)
