...
def parse_args():
    ...
    ###### Modified ######
    parser.add_argument('--offload-type', type=str, default=None,
    ...
    parser.add_argument('cxl_load_time_per_mb', type=float, default=0.015,
                        help='CXL load time per MB')
    parser.add_argument('local_load_time_per_mb', type=float, default=0.05,
