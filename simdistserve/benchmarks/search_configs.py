...
def get_distserve_configs(
    ...
    possible_tps = get_model_possible_tp(model_type)
    possible_pps = get_model_possible_pp(model_type)
...
def get_vllm_config(
    ...
    model_name: str = ModelTypes.formalize_model_name(ModelTypes.model_str_to_object(model_type))
